...
## Submitting your changes
 ...
 4. If your branch conflicts with the master branch, you will need to rebase and repush it with the following commands:
    ...
    ``` bash
    $ git remote add upstream git@github.com:trsteel88/TrsteelCkeditorBundle.git
 ...
 * [GitHub pull request documentation][gh-pr]
 ...
 [issue]:   https://github.com/trsteel88/TrsteelCkeditorBundle/issues/new
 [pr]:      https://github.com/trsteel88/TrsteelCkeditorBundle/pull/new

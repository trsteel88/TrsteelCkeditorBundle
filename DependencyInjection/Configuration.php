...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->end()
            ->children()
                ->scalarNode('filebrowserBrowseUrl')
                    ->defaultNull()
                ->end()
            ->end()
            ->children()
                ->scalarNode('filebrowserUploadUrl')
                    ->defaultNull()
                ->end()
            ->end()            
            ->children()
                ->scalarNode('filebrowserImageBrowseUrl')
                    ->defaultNull()
                ->end()
            ->end()
            ->children()
                ->scalarNode('filebrowserImageUploadUrl')
                    ->defaultNull()
                ->end()
            ->end()   
            ->children()
                ->scalarNode('filebrowserFlashBrowseUrl')
                    ->defaultNull()
                ->end()
            ->end()
            ->children()
                ->scalarNode('filebrowserFlashUploadUrl')
                    ->defaultNull()
                ->end()
            ->end()   
        ;

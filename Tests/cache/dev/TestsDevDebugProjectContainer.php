...
/**
 * TestsDevDebugProjectContainer
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class TestsDevDebugProjectContainer extends Container
{
    /**
     * Constructor.
     */
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/Resources');
    ...
    {
        $this->services['event_dispatcher'] = $instance = new \Symfony\Bundle\FrameworkBundle\Debug\TraceableEventDispatcher($this, $this->get('debug.stopwatch'), NULL);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/Resources');
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/config/routing.yml', array('cache_dir' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'TestsdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'TestsdevUrlMatcher'), new \Symfony\Component\Routing\RequestContext('', 'GET', 'localhost', 'http', 80, 443));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_FormService()
    {
        ...
        return $this->services['templating.helper.form'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\FormHelper($a, NULL, array(0 => 'FrameworkBundle:Form'));
    }
    ...
    protected function getTranslation_WriterService()
    {
        ...
        $instance->addDumper('xlf', $this->get('tranlsation.dumper.xliff'));
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.rb' => array(0 => 'rb'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        return $this->services['trsteel_ckeditor.form.type'] = new \Trsteel\CkeditorBundle\Form\CkeditorType($this);
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(NULL, array(0 => 'form_div_layout.html.twig', 1 => 'TrsteelCkeditorBundle:Form:ckeditor_widget.html.twig')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/vendor/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'Tests',
            'kernel.cache_dir' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev',
            'kernel.logs_dir' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/logs',
            ...
            'kernel.container_class' => 'TestsDevDebugProjectContainer',
            ...
            'debug.container.dump' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev/TestsDevDebugProjectContainer.xml',
            ...
            'router.options.matcher.cache_class' => 'Tests%kernel.environment%UrlMatcher',
            'router.options.generator.cache_class' => 'Tests%kernel.environment%UrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.resource' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/usr/local/zend/apache2/htdocs/TrsteelCkeditorBundle/Tests/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'trsteel_ckeditor.ckeditor.ui_colour' => NULL,
